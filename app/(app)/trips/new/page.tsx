...
export default function NewTripPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="px-4 pt-12 pb-4 bg-white border-b border-gray-100 flex items-center gap-3">
        <button onClick={() => router.back()} className="text-gray-500 active:text-gray-800">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden divide-y divide-gray-100">
          ...
          <Field label="Date *">
            <input
              ...
              required
              className="flex-1 text-base bg-transparent focus:outline-none text-gray-800"
            />
          </Field>
          <Field label="Notes">
            <input
